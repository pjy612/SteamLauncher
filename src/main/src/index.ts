...
if (typeof appCommandsLine.appid === 'undefined' && !app.requestSingleInstanceLock()) {
  app.quit();
}
...
app.on('ready', async () => {
  ...
  await (typeof appCommandsLine.appid !== 'undefined' ? SteamGame.launchFromAppCommandsLine() : appCreateWindow());
});
